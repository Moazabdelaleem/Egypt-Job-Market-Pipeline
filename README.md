# 📊 Egypt Job Market Pipeline (Target_Job_Board)

An automated, end-to-end data engineering pipeline designed to harvest Business Intelligence, Data Science, and Data Engineering job postings from Target_Job_Board, Egypt's leading job platform.
...
1. **Extraction (`target_job_board_spider.py`)**
   * Uses Scrapy and Playwright to crawl Target_Job_Board.
